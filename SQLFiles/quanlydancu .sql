...
--
-- Host: localhost    Database: quan_ly_covid_19
-- ------------------------------------------------------
...
CREATE TABLE `cach_ly` (
  `id_CachLy` int NOT NULL,
  `id_nhankhau` int NOT NULL,
  `diaDiemCachLy` varchar(100) NOT NULL,
  `thoiGianBatDau` datetime NOT NULL,
  `muDoCachLy` varchar(50) NOT NULL,
  `hetBenh` bit(2) NOT NULL,
  PRIMARY KEY (`id_CachLy`),
  KEY `id_NhanKhau_idx` (`id_nhankhau`),
  CONSTRAINT `id_NhanKhau` FOREIGN KEY (`id_nhankhau`) REFERENCES `test` (`id_nhankhau`)
...
CREATE TABLE `khai_bao` (
  `id_khaibao` int NOT NULL,
  `id_nhankhau` int NOT NULL,
  `vung_dich` varchar(50) NOT NULL,
  `bieu_hien` varchar(50) NOT NULL,
  `ngay_khai_bao` datetime NOT NULL,
  PRIMARY KEY (`id_khaibao`),
  KEY `id_nhankhau_kb_fk_idx` (`id_nhankhau`),
  CONSTRAINT `id_nhankhau_kb_fk` FOREIGN KEY (`id_nhankhau`) REFERENCES `quan_ly_nhan_khau`.`nhan_khau` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `test` (
  ...
  PRIMARY KEY (`id_test`),
  KEY `id_nhankhau_fk` (`id_nhankhau`),
  CONSTRAINT `id_nhankhau_fk` FOREIGN KEY (`id_nhankhau`) REFERENCES `quan_ly_nhan_khau`.`nhan_khau` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-11-29  0:40:22
-- MySQL dump 10.13  Distrib 8.0.27, for Win64 (x86_64)
--
