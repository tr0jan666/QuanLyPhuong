        ...
        try {
            if (!tuTuoiText.getText().trim().isEmpty()) {
                ...
                if(tuTuoi <0){
                    ...
                    alert.setContentText("Tuổi không được là số âm. Nhập lại !!");
                    alert.show();
                }
            } else {
                tuTuoi = 0;
            ...
            if (!denTuoiText.getText().trim().isEmpty()) {
                ...
                if (!tuTuoiText.getText().trim().isEmpty()) {
                    ...
                    if(denTuoi < tuTuoi){
                        Alert alert = new Alert(Alert.AlertType.WARNING);
                        alert.setTitle("Warning!");
                        alert.setContentText(" Tuổi ở ô 'Từ' phải nhỏ hơn tuổi ở ô 'Đến'. Nhập lại !!");
                        alert.show();
                    }
                }
            } else {
            ...
            if (!tuNamText.getText().trim().isEmpty()) {
                ...
                if(tuNam <0){
                    Alert alert = new Alert(Alert.AlertType.WARNING);
                    alert.setTitle("Warning!");
                    alert.setContentText("Năm không được là số âm. Nhập lại !!");
                    alert.show();
                }
            }
            if (!denNamText.getText().trim().isEmpty()) {
                ...
                if (!tuNamText.getText().trim().isEmpty()) {
                    ...
                    if(denNam < tuNam){
                        Alert alert = new Alert(Alert.AlertType.WARNING);
                        alert.setTitle("Warning!");
                        alert.setContentText("Thống kê theo năm không hợp lệ. Năm trước phải nhỏ hơn Năm sau" +
                                " . Nhập lại !!");
                        alert.show();
                    }
                }
            ...
            Alert alert = new Alert(Alert.AlertType.WARNING);
            alert.setTitle("Warning!");
            alert.setContentText("Nhập sai dữ liệu. Vui lòng nhập lại kiểu dữ liệu");
            alert.show();
        }
